...
description: Key metrics tracking GPU production, training compute, efficiency trends, and semiconductor capacity
sidebar:
  order: 1
---
...
- **Language modeling**: Algorithms account for 22,000x improvement on paper (2012-2023)
  - Actual measured innovations account for <100x
...
- For significantly different allocations (10x difference), α must be <0.1 or >10
...
The actual contribution of algorithmic improvements vs. scale-dependent effects remains debated. Measured innovations account for <100x of the claimed 22,000x improvement, with the gap attributed to scaling effects that are harder to isolate.
