...
<Mermaid client:load chart={`
graph TB
    subgraph Individual["Individual Level (6mo-3yr)"]
        I1[Preference Reinforcement]
        I2[Skill Atrophy]
        I3[Emotional Dependency]
    end

    subgraph Market["Market Level (2-5yr)"]
        M1[Competitive Sycophancy]
        M2[Training Data Contamination]
    end

    subgraph Societal["Societal Level (3-15yr)"]
        S1[Polarization Amplification]
        S2[Institutional Erosion]
    end
    ...
    style Individual fill:#e8f4f8
    style Market fill:#fef8e8
    style Societal fill:#f8e8f0
`} />
