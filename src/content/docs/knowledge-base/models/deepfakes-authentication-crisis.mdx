...
```mermaid
flowchart TD
    A[Generative AI<br/>Capability Improvement] --> B[Synthetic Media<br/>Quality Increases]
    B --> C{Detection<br/>Keeps Pace?}
    C -->|Yes| D[Temporary Equilibrium]
    D --> A
    C -->|No| E[Human Detection<br/>Falls to Chance]
    E --> F[Technical Detection<br/>Fails]
    F --> G[Authentication Crisis<br/>Threshold Crossed]
    G --> H[Direct Deception<br/>Becomes Viable]
    G --> I[Liar's Dividend<br/>Becomes Universal]
    H --> J[Evidentiary<br/>Collapse]
    I --> J
    J --> K[Legal System<br/>Adaptation Required]
    J --> L[Journalism<br/>Transformation]
    J --> M[Social Trust<br/>Erosion]

    N[Content Provenance<br/>Adoption] --> O{Achieves<br/>Critical Mass?}
    O -->|Yes| P[Two-Tier Media<br/>System Emerges]
    O -->|No| Q[Crisis<br/>Unmitigated]
    P --> R[Partial Trust<br/>Restoration]
    Q --> J
```
...
| Audio | 2026-2027 (proj.) | 48-52% | 55-60% | <3 seconds | **Crisis** |
...
| Full Crisis | 20% | <20% | ~50% | High - severe disruption | Coordination failure, rapid AI progress |
