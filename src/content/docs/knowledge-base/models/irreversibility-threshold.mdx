...
stateDiagram-v2
    ...
    note right of FullyReversible: R&D Phase\nCost: $K-$M\nTime: Days-Weeks

    CostlyReversible --> PracticallyIrreversible: Lock-in Effects
    note right of CostlyReversible: Deployment Phase\nCost: $M-$B\nTime: Months-Years

    PracticallyIrreversible --> AbsolutelyIrreversible: Existential Threshold
    note right of PracticallyIrreversible: Integration Phase\nCost: $B-$T\nTime: Years-Decades

    AbsolutelyIrreversible --> [*]: No Return
    note right of AbsolutelyIrreversible: Terminal State\nCost: Infinite\nTime: Permanent
