...
stateDiagram-v2
    [*] --> FullyReversible: Initial Decision

    FullyReversible --> CostlyReversible: Deployment
    note right of FullyReversible: R and D Phase Cost: $K-$M Time: Days-Weeks

    CostlyReversible --> PracticallyIrreversible: Lock-in Effects
    note right of CostlyReversible: Deployment Phase Cost: $M-$B Time: Months-Years

    PracticallyIrreversible --> AbsolutelyIrreversible: Existential Threshold
    note right of PracticallyIrreversible: Integration Phase Cost: $B-$T Time: Years-Decades

    AbsolutelyIrreversible --> [*]: No Return
    note right of AbsolutelyIrreversible: Terminal State Cost: Infinite Time: Permanent

    CostlyReversible --> FullyReversible: Early Reversal
    PracticallyIrreversible --> CostlyReversible: Costly Reversal
`} />
