...
```mermaid
flowchart TD
    subgraph "Threshold Progression"
        T1[Threshold 1<br/>Knowledge Democratization]
        T2[Threshold 2<br/>Synthesis Assistance]
        T3[Threshold 3<br/>Novel Agent Design]
        T4[Threshold 4<br/>Full Attack Automation]
    end
    ...
    subgraph "Risk Profile"
        R1[Expanded Actor Pool<br/>Low Sophistication]
        R2[Reduced Barriers<br/>Medium Sophistication]
        R3[Novel Threats<br/>High Sophistication]
        R4[Scalable Attacks<br/>Maximum Danger]
    end
