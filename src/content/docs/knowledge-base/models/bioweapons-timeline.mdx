...
flowchart TD
    subgraph ThresholdProgression["Threshold Progression"]
        T1["Threshold 1: Knowledge Democratization"]
        T2["Threshold 2: Synthesis Assistance"]
        T3["Threshold 3: Novel Agent Design"]
        T4["Threshold 4: Full Attack Automation"]
    end

    subgraph Enablers["Enablers"]
        E1[LLM Capabilities]
        E2[Lab Automation]
        E3[Protein Engineering AI]
        E4[System Integration]
    end

    subgraph RiskProfile["Risk Profile"]
        R1["Expanded Actor Pool - Low Sophistication"]
        R2["Reduced Barriers - Medium Sophistication"]
        R3["Novel Threats - High Sophistication"]
        R4["Scalable Attacks - Maximum Danger"]
    end
